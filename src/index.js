...
accImg.src = "http://localhost:9000/img/accent.png";
...
ctaS.children[0].children[0].textContent = siteContent.cta.h1;
ctaS.children[0].children[1].textContent = siteContent.cta.button;
